...
project "Break_Graphics"
	...
	if _ACTION == "vs2012" then
		libdirs{"Graphics/deps/freetype/lib-vs2012"}
	elseif _ACTION == "vs2015" then
		libdirs{"Graphics/deps/freetype/lib-vs2015"}
	end
...
project "Break_Infrastructure"
	...
	if os.get() == "windows" then
		...
		includedirs{
			...
			"Infrastructure/deps/glfw-3.1.2.bin.WIN32/include",
		...
		if _ACTION == "vs2010" then
			libdirs{
				"Infrastructure/deps/glfw-3.1.2.bin.WIN32/lib-vc2010"
			}
		elseif _ACTION == "vs2012" then
			...
			libdirs{
				"Infrastructure/deps/glfw-3.1.2.bin.WIN32/lib-vc2012",
				"Infrastructure/deps/portaudio_vs2012/lib/release"
			}
		elseif _ACTION == "vs2013" then
			libdirs{
				"Infrastructure/deps/glfw-3.1.2.bin.WIN32/lib-vc2013"
			}
		elseif _ACTION == "vs2015" then
			includedirs{
				"Infrastructure/deps/portaudio_vs2015/inc/"
			}
			libdirs{
				"Infrastructure/deps/glfw-3.1.2.bin.WIN32/lib-vc2015",
				"Infrastructure/deps/portaudio_vs2015/lib/release"
			}
		else
			libdirs{
				"Infrastructure/deps/glfw-3.1.2.bin.WIN32/lib-mingw"
			}
		end
