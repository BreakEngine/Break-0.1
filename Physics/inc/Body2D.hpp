...
namespace Break
{
	...
	namespace physics
	{
		...
		private:
			...
			Transform2D m_xf;		// the body origin Transform2D
		...
		inline void Body::SynchronizeTransform2D()
		{
			...
			m_xf.p = m_sweep.c - MathUtils::Mul(m_xf.q, m_sweep.localCenter);
		}
