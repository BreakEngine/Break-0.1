...
namespace Break
{
	...
	namespace Physics
	{
		...
		struct BREAK_API ContactResult;
		struct BREAK_API Manifold;

		/// Joints and fixtures are destroyed when their associated
		/// body is destroyed. Implement this listener so that you
		/// may nullify references to these joints and shapes.
		class BREAK_API DestructionListener
		{
		public:
		...
		{
			real32 normalImpulses[maxManifoldPoints];
			real32 tangentImpulses[maxManifoldPoints];
			s32 count;
		};
		...
		/// See World::RayCast
		class BREAK_API RayCastCallback
		{
		public:
			...
			virtual real32 ReportFixture(	Fixture* fixture, const glm::vec2& point,const glm::vec2& normal, real32 fraction) = 0;
		};
